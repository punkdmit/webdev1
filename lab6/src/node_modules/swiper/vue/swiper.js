...
import { renderLoop, calcLoopedSlides } from 'swiper/vue/loop.js';
import { getChangedParams } from 'swiper/vue/get-changed-params.js';
import { getChildren } from 'swiper/vue/get-children.js';
import { updateSwiper } from 'swiper/vue/update-swiper.js';
import { renderVirtual, updateOnVirtualData } from 'swiper/vue/virtual.js';
const Swiper = {
  name: 'Swiper',
  props: {
    tag: {
